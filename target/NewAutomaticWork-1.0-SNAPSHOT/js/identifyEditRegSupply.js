...
// person start
    ...
    function SavePersonRow() {
        ...
        $.ajax({
            url : "../reg/submitEditPersonSupply.html?operateType="+operateType,
            type:"post",
            ...
            success : function(data) {
                ...
                location.href = "../caseinfo/editSupply.html?consignmentId=" + $("#consignmentId","#consignment_form").val();
...
// sample start
    ...
    function SaveSampleRow() {
        ...
        $.ajax({
            url : "../reg/submitEditSampleSupply.html?operateType=" + operateType,
            type:"post",
            contentType:  "application/json; charset=utf-8",
            data : JSON.stringify(params),
            dataType : "json",
